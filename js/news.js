...
$('#cageNewsHead').text('CAGE - Castle Age Game Enhance - V 1.0.39α');
$('#cageNewsText').text('You\'re now running CAGE and making your Castle Age life a bit easier ;)');
$('#cageNewsFoot').prepend('<p style="text-align: left;"><b>IMPORTANT:</b> The Assister is now available for testing. It can assist up 10 CTAs from the Live Feed and assist only friends. It likes and comments the post on the users newsfeed and on the monster. If you notice anything weird, just go to the blog and post there (no need to sign up).<br>Error logs (CTRL+SHIFT+J) are always welcome ;)</p>')
_news = [
