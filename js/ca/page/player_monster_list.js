...
tools['Page'].runtime['player_monster_list.php'] = function () {
	...
	$_list.append('<img id="cageTempLoaderImg" src="http://image4.castleagegame.com/graphics/shield_wait.gif" style="margin-left: 360px; height: 30px;margin-bottom: 10px;">');
	$.get('festival_tower.php?tab=monster&signed_request=' + CastleAge.signed_request, function(_festMonster) {
		$('#cageTempLoaderImg').remove();
