...
tools['Page'].runtime['player_monster_list.php'] = function() {
	...
	var _background = 'background-image:url("http://image4.castleagegame.com/graphics/monsterlist_container.gif"); background-repeat:no-repeat; height:90px; padding-bottom:15px;';
