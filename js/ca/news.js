...
function cageNews(_full) {
	...
	$.each([
			'ADD: Crusaders to Home menu',
			'FIX: General names (1.1.34)',
			'FIX: General att/def stats not showing',
			'FIX: Black screens on start',
			'FIX: Goblin, Livefeed, Raid missing in menu'
		], function(_i, _e) {
