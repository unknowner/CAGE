...
{
	friendListWait:false,friendListCallbacks:[],friendlists:[],idWait:false,idCallbacks:[],id:[],friendlistId:
	{
	},listMembersWait:false,listMembersNext:[]
};
/*
...
tools.Facebook.init= function() {
	$(document.body).append($('<img src="http://www.facebook.com/favicon.ico" style="cursor:pointer;position:fixed;top:1;left:2px;">').data('hidden',false).click(function() {
